...
def create_env(scenario: str, **kwargs):
...
# Wrap environment with VecEnv object for stable-baselines
def create_vec_env(**kwargs) -> common.vec_env.VecTransposeImage:
    return common.vec_env.VecTransposeImage(common.vec_env.DummyVecEnv([lambda: create_env(**kwargs)]))
...
if __name__ == "__main__":
    ...
    # Define structure of observation space: RGB image of shape (height, width, channels) w/
    ...
    # Create dictionary for create vec env kwargs
    env_args = {
        'scenario': 'basic',
        'frame_skip': 4,
